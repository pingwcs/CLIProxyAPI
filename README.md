...
Since v6.10.0, CLIProxyAPI and [CPAMC](https://github.com/pingwcs/Cli-Proxy-API-Management-Center) no longer ship built-in usage statistics. If you need usage statistics, use:
